...
"color: white;*/")
        ...
        self.category_tree.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.label_table.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.horizontalLayout_3.addLayout(self.cat_and_lab_container)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ref_box_title.sizePolicy().hasHeightForWidth())
        self.ref_box_title.setSizePolicy(sizePolicy)
        self.ref_box_title.setStyleSheet("")
        self.ref_box_title.setObjectName("ref_box_title")
        self.verticalLayout_3.addWidget(self.ref_box_title)
        ...
        self.date_search = QtWidgets.QDateEdit(self.tab)
        ...
        self.reference_table = QtWidgets.QTableWidget(self.tab)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "References"))
